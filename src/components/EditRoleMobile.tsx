  ...
  return (
    <div className="flex flex-col items-center min-h-screen p-6 w-full">
      ...
      <motion.button
        ...
        className={`inline-flex items-center gap-2 font-semibold py-3 px-8 rounded-2xl shadow-md transition-all duration-200 w-[185px] mt-20 ${
          selectedRole && mobileNumber.length === 10

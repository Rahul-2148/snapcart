...
// nextStep is optional; when not provided we fall back to login navigation
const Welcome = ({ nextStep }: { nextStep?: (step: number) => void }) => {
  const handleNext = () => {
    ...
    // fallback for guest homepage: go to login
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen text-center p-6 bg-linear-to-b from-green-100 to-white">
      ...
      >
        ...
        daily essentials delivered right to your doorstep in just 10 minutes!
      </motion.p>
